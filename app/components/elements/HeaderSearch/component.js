...
import { Animated, TextInput, View, Text, TouchableOpacity, SafeAreaView } from 'react-native';
import PropTypes from 'prop-types';
import styles from './styles';
import { COLOR_WHITE, COLOR_GREY_DARK, COLOR_GREY } from '../../../styles/index';
...
export default class Component extends React.Component {
  ...
  render() {
    ...
    const { props } = this;
    const colors = color || COLOR_WHITE;
        ...
        <SafeAreaView style={{ backgroundColor: colors }}>
          <View
            style={[
              ...
              { backgroundColor: colors, borderBottomWidth: 0.5, borderBottomColor: COLOR_GREY }
            ]}
          >
            {props.left &&
      ...
      <Animated.View>
        <TouchableOpacity onPress={props.onPress}>
          <Animated.View style={[styles.containerIcon, { opacity: props.opacity }]}>
            <Animated.Image
              style={[styles.icon, { tintColor: props.tint || COLOR_GREY_DARK }, props.styleIconClose]}
              resizeMode="contain"
              source={props.icon || ''}
              tintColor={props.tint || COLOR_GREY_DARK}
            />
          </Animated.View>
        </TouchableOpacity>
      </Animated.View>
